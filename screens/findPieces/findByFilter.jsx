...
export default function FindPiece() {
  ...
  const filterSheets = useRef(null);
  ...
  return (
    ...
    >
      <View style={{ flex: 1, backgroundColor: colors.background }}>
        <RBSheet
          ref={filterSheets}
          closeOnPressMask={true} // close when tapping outside
          closeOnDragDown={true} // optional: allow drag to close
          animationType="slide" // only the sheet will slide
          customModalProps={{
            // make backdrop appear immediately (not with animation)
          ...
          customStyles={{
            wrapper: {
              backgroundColor: 'rgba(0,0,0,0.5)', // static backdrop
            },
            draggableIcon: {
              backgroundColor: '#ccc',
            },
        ...
        <Button
          ...
          onPress={() => {filterSheets.current.open()}}
        >
          Filtros
        </Button>
